...
// rounded-sm  bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:p-[60px]max-w-[500px]
const Profile = () => {
    return (
        <>
                                        ...
                                        <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                                            ...
                                            <div className="w-full sm:w-1/2">
                                                ...
                                                <input
                                                    ...
                                                    name="phoneNumber"
                                                    id="phoneNumber"
                                                    placeholder="2181147640"
                                                    defaultValue="2181147640"
                                                />
                                            </div>
                                        </div>
                                ...
                                <div className="p-7">
                                    <form action="#">
                                        <div className="mb-4 flex items-center gap-3">
                                            <div>
                                                <span className="mb-3 text-center text-2xl text-black dark:text-white sm:text-3xle">
                                                    Edit your photo
                                                </span>
